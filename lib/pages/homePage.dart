...
class _HomePageState extends State<HomePage>
{
  ...
  static final List<String> chartDropdownItems = [ 'Tuần trước', 'Tháng trước', 'Năm trước' ];
    ...
    return Scaffold
      (
        appBar: AppBar
          ...
          title: Text('Thống Kê', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
          actions: <Widget>
          [
            Container
              (
              ...
              child: Row
                ...
                children: <Widget>
                [
                  Text(' ', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Công việc', style: TextStyle(color: Colors.blueAccent)),
                          Text('15', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                        ],
                      ),
                      Material
                        (
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Lịch công tác', style: TextStyle(color: Colors.blueAccent)),
                          Text('4', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                        ],
                      ),
                      Material
                        (
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Đang xử lý', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 20.0)),
                      Text('Nội bộ (14) , Bên ngoài(5)', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Padding(padding: EdgeInsets.only(bottom: 16.0)),
                      Text('Sắp hết hạn', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 20.0)),
                      ...
                      Row
                        ...
                        [
                          Column
                            ...
                            children: <Widget>
                            [
                              Text('Phản ánh', style: TextStyle(color: Colors.green)),
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Hết hạn', style: TextStyle(color: Colors.redAccent)),
